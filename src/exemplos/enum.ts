...
const gabriel: Pessoa = {
  ...
  idade: 26,
  casado: false,
  trabalho: Profissao.Pintor, // E aqui usamos ele para definir de forma padronizada a profissão de cada objeto do tipo Pessoa
};
...
const mario: Pessoa = {
  ...
  idade: 26,
  casado: false,
  trabalho: Profissao.Porteiro, // Tudo padronizado e consistente
};
